...
public class Enunciado4 extends javax.swing.JFrame {
   ...
   private float PCamisas(){
    ...
    private void mostrar(){
        ...
        SDescuento.setText(String.valueOf(SDesc()));
        DTotal.setText(String.valueOf(Tdesc()));
        IPagar.setText(String.valueOf(Itot()));
